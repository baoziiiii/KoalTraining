...
public class DESUtil {
    ...
    public static final String CIPHER_MODE_ECB ="DES/ECB/";
    public static final String CIPHER_MODE_CBC ="DES/CBC/";
    public static final String CIPHER_MODE_CFB ="DES/CFB/";
    public static final String CIPHER_MODE_OFB ="DES/OFB/";
    ...
    private static SecretKey generateKey(String keyHexStr) throws Exception{
        ...
        SecretKeySpec secretKeySpec=new SecretKeySpec(input,"DES");
...
//      String keystr="6C4E60E55552386C759569836DC0F83869836DC0F838C0F7" ;
        ...
        byte[] ivBytes=new byte[8];                       //DES iv是8位
