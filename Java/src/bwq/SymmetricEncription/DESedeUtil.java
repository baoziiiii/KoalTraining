...
public class DESedeUtil{
    ...
    public static final String CIPHER_MODE_ECB ="DESede/ECB/";
    public static final String CIPHER_MODE_CBC ="DESede/CBC/";
    public static final String CIPHER_MODE_CFB ="DESede/CFB/";
    public static final String CIPHER_MODE_OFB ="DESede/OFB/";
    ...
    private static SecretKey generateKey(String keyHexStr) throws Exception{
        ...
        SecretKeySpec secretKeySpec=new SecretKeySpec(input,"DESede");
    ...
    */
    ...
    public static void main(String[] args)throws Exception{
        ...
        keyGenerator.init(168);                                //3DES密钥168位
        byte[] keyCoded=keyGenerator.generateKey().getEncoded();
        String keystr=Hex.encodeHexString(keyCoded);


//      String keystr="6C4E60E55552386C759569836DC0F83869836DC0F838C0F7" ;
        ...
        byte[] ivBytes=new byte[8];                       //3DES iv是8位
        ...
        System.out.println("base64 crypt("+CIPHER_MODE_OFB+"):"+base64crypt);
